...
, libxml2
, xar
, wasi-libc ? pkgs.pkgsCross.wasi32.wasilibc
...
let
  ...
  inherit (llvmPackages_15) llvm clang compiler-rt lld;
in
...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "tinygo";
    rev = "v${version}";
    sha256 = "1r527vc6m2hx57hakzmqjl7jq7v4pfsn662a5s2i4jd786sjak5s";
    fetchSubmodules = true;
  };

  vendorSha256 = "1pfljv1y3ylxr5r30p4plhwhlcgxxnsvqcaxmc09ngzn9l7cpcn0";
